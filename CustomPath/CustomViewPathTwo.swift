...
class CustomViewPathTwo: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        path.addCurve(to: CGPoint(x: centerWidth, y: height * 1.7 / 3),
                      controlPoint1: CGPoint(x: centerWidth - cornerRadius - 10, y: 0),
                      controlPoint2: CGPoint(x: centerWidth - cornerRadius - 5, y: height * 1.7 / 3))
        
        path.addCurve(to: CGPoint(x: centerWidth + height, y: 0),
                      controlPoint1: CGPoint(x: centerWidth + cornerRadius + 5, y: height * 1.7 / 3),
                      controlPoint2: CGPoint(x: centerWidth + cornerRadius + 10, y: 0))
